            ...
            <tr>
              <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                <a href="${'https://travoofy.com'}">
                  <img src="${'https://travoofy.com/logo.png'}" width="60" alt="PayRev" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; display: block; margin-left: auto; margin-right: auto;">
                </a>
                ...
                <p style="margin: 0 0 16px;">Thanks, <br>The PayRev Team</p>
...
export const paymentNotifTemplate = ({ subject, body }: OtpMailTemplateDataType) => {
	return `
      ...
      <tr>
        <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
          <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                <a href="${'https://fountain-pay.com'}">
                  <img src="${'https://fountain-pay.com/images/FountainPay-logo.png'}" width="120" alt="PayRev" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; display: block; margin-left: auto; margin-right: auto;">
                </a>
                <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Hi,</p>
                ...
                <p style="margin: 0 0 16px;">
                  Not sure why you received this email? Please
                  <a href="mailto:${'support@fountainpay.ng'}" class="hover-underline" style="--text-opacity: 1; color: #7367f0; text-decoration: none;">let us know</a>.
                </p>
                <p style="margin: 0 0 16px;">Thanks, <br>The PayRev Team</p>
                <p style="cursor: default; margin-bottom: 16px;">
                  <a href="${'https://www.facebook.com/travoofy'}" style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img src="https://res.cloudinary.com/bringforthjoy/image/upload/v1612088043/INVESTA/social/036-facebook_sbyrqb.png" width="17" alt="Facebook" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
            ...
            <tr>
              <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                <a href="${config.WEBSITE}">
                  <img src="${
		config.LOGO
	}" width="120" alt="Venite University" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; display: block; margin-left: auto; margin-right: auto;">
                </a>
                ...
                <!-- <p style="margin: 0 0 16px;">
                  Not sure why you received this email? Please
                  <a href="mailto:${'we@luka.finance'}" class="hover-underline" style="--text-opacity: 1; color: #7367f0; text-decoration: none;">let us know</a>.
                </p> -->
                <p style="margin: 0 0 16px;">Thanks, <br>The Venite Team</p>
                <p style="cursor: default; margin-bottom: 16px;">
                  <a href="${'https://www.facebook.com/profile.php?id=100094609575234&mibextid=LQQJ4d'}" style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img src="https://res.cloudinary.com/bringforthjoy/image/upload/v1612088043/INVESTA/social/036-facebook_sbyrqb.png" width="17" alt="Facebook" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                  
                  <a href="${'https://twitter.com/VeniteUni_NG'}" style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img src="https://res.cloudinary.com/bringforthjoy/image/upload/v1612088043/INVESTA/social/008-twitter_be0fxj.png" width="17" alt="Twitter" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                  
                  <a href="${'https://www.instagram.com/veniteuniversity'}" style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img src="https://res.cloudinary.com/bringforthjoy/image/upload/v1612088041/INVESTA/social/029-instagram_u7embu.png" width="17" alt="Instagram" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                </p>
              </td>
            </tr>
          </table>
